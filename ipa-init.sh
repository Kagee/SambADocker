...
ST="podman exec -it freeipa-server ipa"
BO="$IPA_OU"

$ST user-find

podman exec -it freeipa-server /bin/bash -c "kdestroy"

exit 1

# "ipa help commands" for the full list of commands.
# See "ipa <COMMAND> --help
{
